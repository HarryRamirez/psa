...
export class SidebarComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.rol = JSON.parse(localStorage.getItem('prm')).rol || this.userService.userDataObj.rol;
    ...
    itemClick(){
        const clickItem1 = document.getElementById('itemC1');
        const clickItem2 = document.getElementById('itemC2');
        const clickItem3 = document.getElementById('itemC3');
        
        if(clickItem1.classList.contains('t-c-b')){
            clickItem1.classList.replace('t-c-b', 'back-sidebar');
            clickItem2.classList.replace('back-sidebar', 't-c-b');
            clickItem3.classList.replace('back-sidebar', 't-c-b');
        }
    }
    item2Click(){
        const clickItem1 = document.getElementById('itemC1');
        ...
        if(clickItem2.classList.contains('t-c-b')){
            clickItem2.classList.replace('t-c-b', 'back-sidebar');
            clickItem1.classList.replace('back-sidebar', 't-c-b');
            clickItem3.classList.replace('back-sidebar', 't-c-b');
        }
    }
    item3Click(){
        ...
        if(clickItem3.classList.contains('t-c-b')){
            clickItem3.classList.replace('t-c-b', 'back-sidebar');
            clickItem1.classList.replace('back-sidebar', 't-c-b');
            clickItem2.classList.replace('back-sidebar', 't-c-b');
        }
    }
